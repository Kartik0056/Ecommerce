...
const Product = () => {
  ...
  const fetchProductData = async () => {
    products.map((item) => {
      ...
      return null; // Ensure you return a value from map function
    });
  };
    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
              ...
              <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
                    ...
                    <p>Discover a variety of products at unbeatable prices. Shop securely, enjoy fast checkout, and get doorstep delivery with ease.</p>
              </div>
      </div>
