  ...
  return (
    ...
    <ul className='hidden sm:flex gap-5 text-gray-700'>
        <NavLink to="/" className="flex flex-col items-center gap-1" >
            <p>HOME</p>
            <hr className='w-2/4 border-none m-auto h-[2px] bg-gray-700 hidden'></hr>
        </NavLink>
      ...
      <div className='flex items-center gap-6'>
            ...
            <img onClick={() => setVisible(true)} src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden h-5' />
      </div>
